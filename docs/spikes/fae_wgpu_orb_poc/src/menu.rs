...
impl OrbMenu {
    pub fn new() -> Result<Self, muda::Error> {
        ...
        append_item(&menu, MenuAction::OpenWorkWithFae, "Open Work with Fae")?;
        append_item(
            &menu,
...
fn id(action: MenuAction) -> MenuId {
    MenuId::new(match action {
        ...
        MenuAction::OpenWorkWithFae => "open_work_with_fae",
...
fn action_from_id(id: &MenuId) -> Option<MenuAction> {
    match id.as_ref() {
        ...
        "open_work_with_fae" => Some(MenuAction::OpenWorkWithFae),
