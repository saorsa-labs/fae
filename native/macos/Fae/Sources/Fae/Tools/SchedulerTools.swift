...
private func defaultBuiltinTasks() -> [SchedulerTask] {
    [
        ...
        SchedulerTask(id: "memory_inbox_ingest", name: "Memory Inbox Ingest", kind: "builtin", enabled: true,
                       scheduleType: "interval", scheduleParams: ["minutes": "5"], action: "memory_inbox_ingest", taskDescription: nil, instructionBody: nil, nextRun: nil, allowedTools: nil),
        SchedulerTask(id: "memory_digest", name: "Memory Digest", kind: "builtin", enabled: true,
                       scheduleType: "interval", scheduleParams: ["hours": "6"], action: "memory_digest", taskDescription: nil, instructionBody: nil, nextRun: nil, allowedTools: nil),
