...
#ifndef FAERELAYKIT_SWIFT_H
#define FAERELAYKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FaeRelayKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Provides an <code>@Observable</code>-friendly interface for SwiftUI binding.
/// Handles discovery, connection lifecycle, JSON message exchange,
/// and binary audio frame relay.
SWIFT_CLASS("_TtC11FaeRelayKit14FaeRelayClient")
@interface FaeRelayClient : NSObject
...
@class MCPeerID;
@class NSString;
@interface FaeRelayClient (SWIFT_EXTENSION(FaeRelayKit)) <MCNearbyServiceBrowserDelegate>
...
@class NSProgress;
@class NSURL;
@interface FaeRelayClient (SWIFT_EXTENSION(FaeRelayKit)) <MCSessionDelegate>
